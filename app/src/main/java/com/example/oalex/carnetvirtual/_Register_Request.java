...
public class _Register_Request extends StringRequest {
    ...
    public _Register_Request(String Name,String FirstName,String Email,String Phone,String Class, String Password,String Address, Response.Listener<String> listener) {
